...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-[600px] lg:min-h-[700px] flex items-center overflow-hidden w-full pt-20">
      ...
      <div className="absolute inset-0 z-0">
        {images.map((image, index) => (
          <img
            ...
            style={index === 1 ? { objectPosition: 'center 80%' } : { objectPosition: 'center' }}
            loading="eager"
          />
        ))}
